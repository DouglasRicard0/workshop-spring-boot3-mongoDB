...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/08/2018"), "Vou viajar", "Vou viajar para São Paulo", maria);
		Post post2 = new Post(null, sdf.parse("23/08/2018"), "Bom Dia", "Acrodei Feliz", maria);
